@php
   ...
   // 결과 처리
       ...
       if( $res_cd == "0000" )
       {
           ...
           $sbParam .= "<input type='hidden' name='name' value='" . iconv("EUC-KR", "UTF-8",  f_get_parm_str( $ct_cert->mf_get_key_value("user_name") ) ) . "'/>";
           $sbParam .= "<input type='hidden' name='contact' value='" . $ct_cert->mf_get_key_value("phone_no") . "'/>";
           $sbParam .= "<input type='hidden' name='birth' value='" . $ct_cert->mf_get_key_value("birth_day") . "'/>";
           $sbParam .= "<input type='hidden' name='sex' value='" . $ct_cert->mf_get_key_value("sex_code") . "'/>";
       }
