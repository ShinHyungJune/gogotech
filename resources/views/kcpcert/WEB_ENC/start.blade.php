    ...
    <script type="text/javascript">
        ...
        function auth_data( frm )
        {
            ...
            for ( i = 0 ; i < frm.length ; i++ )
            {
                if($("#" + frm.elements[i].name).length > 0)
                    $("#" + frm.elements[i].name).val(frm.elements[i].value);
        ...
        function auth_type_check()
        {
            ...
            else
            {
                ...
                auth_form.action = "/request"; // 인증창 호출 및 결과값 리턴 페이지 주소
...
<div align="center">
    ...
    <div class="test">
        <form name="form_send" method="post" action="/certifications">
            <input type="hidden" id="contact" name="contact">
            <input type="hidden" id="birth" name="birth">
            <input type="hidden" id="DI" name="DI">
            <input type="hidden" id="CI" name="CI">
            <input type="hidden" id="sex_code" name="sex_code">
            <input type="hidden" id="name" name="name">
            <input type="hidden" id="comm_id" name="comm_id">
        </form>

        <form name="form_auth" accept-charset="euc-kr">
            <div class="area-login">
                <div class="wrap-middle">
                    <div class="form type01">
                        <div class="wrap-small">
                            <h3 class="title" style="font-size:24px; font-weight:bold;">
                                "본인인증 후 회원가입 <br/>절차를 진행해주세요."
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="background-image:url('../img/boxbg589.gif')">
                        <!-- 상단 테이블 Start -->
                        <table width="551px" align="center" cellspacing="0" cellpadding="16" style="position:absolute; opacity:0; z-index:-1;">
                        ...
                        <table width="527" align="center" cellspacing="0" cellpadding="0" class="margin_top_20" style="position:absolute; opacity:0; z-index:-1;">
                            ...
                            <tr>
                                ...
                                <td class="sub_content1"><input type="text" name="phone_no" value=""  class="frminput" /></td>
                            </tr>
                            <!-- 명의자명 -->
                            <tr>
                                <td class="sub_title1">성명</td>
                        ...
                        <!-- 인증요청 버튼 테이블 Start -->
                        <div class="btns center" style="display:flex; justify-content: center;">
                            <button type="submit" src="../img/btn_certi.gif" onclick="return auth_type_check();" alt="인증을 요청합니다" class="btn type02">본인인증하기</button>
                        </div>
...
<style>
    .test {height:100vh; display:flex; align-items: center; justify-content: center;}
    .test form {margin-bottom:100px;}
</style>
</body>
</html>
