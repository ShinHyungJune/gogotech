<template>
    <div>
        ...
        <div :class="`m-dashboard-sidebar ${active ? 'active' : ''}`">
            <div class="box-top">
                <h3 class="title">안녕하세요, <span class="point">{{user.name ? user.name : '소셜로그인'}}</span>님!</h3>
                <p class="body">보유포인트 : {{ user.point.toLocaleString() }}원</p>
            ...
            <div class="menus-wrap">
                <div class="menus">
                    <div class="menu-wrap">
                        <h3 class="menu">설문조사</h3>
                    </div>

                    <div class="menus">
                        <div class="menu-wrap">
                            <Link href="/surveys/mine" class="menu">참여내역</Link>
                        </div>
                        <div class="menu-wrap">
                            <Link href="/refunds" class="menu">포인트 교환내역</Link>
                        </div>
                    </div>
                </div>
