    ...
    <div class="area-message-history">
        <div class="sub-wrap">
            <div class="wrap-middle">
                <h3 class="title"><img src="/img/message.png" alt="">전송내역</h3>
        ...
        <div class="wrap-middle">
            <table class="m-table type01" style="width:400px; margin-left:auto;">
                <thead>
                <tr>
                    <th>전체</th>
                    <th>성공</th>
            ...
            <table class="m-table type01 mt-40">
                <thead>
                <tr>
                    <th>수신번호</th>
                    <th>결과상세</th>
            ...
            <div class="m-box-comment type01 mt-40">
                ...
                <div class="m-before-square">전송실패건 환불은 전송시도가 완료된 시점에 처리됩니다.</div>
