    ...
    <div>
        ...
        <div class="area-address">
            <div class="wrap-middle">
                <div class="btns flex-end mt-20">
                    <div class="m-input-withBtn type01">
                        <div class="m-input m-input-text type01">
                            <input type="text" placeholder="그룹명을 입력해주세요" v-model="form.title">
                        </div>
                        <button type="button" class="m-input-btn type-yellow" @click="add">그룹추가</button>
                    </div>
                    <p class="m-input-error">{{form.errors.title}}</p>
                </div>

                <div class="m-empty type01 mt-20" v-if="books.data.length === 0">
                    데이터가 없습니다.
                </div>
                ...
                <div class="m-table-wrap mt-20" v-else>
                    <table class="m-table type02">
                        ...
                        <tr v-for="book in books.data" :key="book.id">
                            ...
                            <td>
                                <div class="btns flex">
                                    <button class="btn type02 bg-red" @click="remove(book)">삭제</button>
                                    <Link :href="`/contacts?book_id=${book.id}`" class="btn type02">그룹관리</Link>
                                </div>
                ...
                <pagination :meta="books.meta" @paginate="(page) => {form.page = page; filter()}" />
...
export default {
    ...
    methods: {
        ...
        remove(book){
            this.form.delete("/books/" + book.id,{
                preserveScroll: true,
                preserveState:false
            });
        },
